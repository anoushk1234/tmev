...
use log::{info, warn};
use searcher_service_client::{get_searcher_client, token_authenticator::ClientInterceptor};
...
async fn main() {
    ...
    let mut client = get_searcher_client(&args.block_engine_url, &args.block_engine_url, &keypair)
        .await
